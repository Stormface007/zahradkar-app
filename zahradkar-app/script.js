...
/** Načte počasí podle geolokace pomocí wttr.in **/
...
function showUdalostForm(typ) {
  ...
  if(typ==="hnojeni") {
    html += `<label>Hnojivo: <input type="text" id="udalostHnojivo"/></label>
             <label>Množství (kg): <input type="number" id="udalostMnozstvi"/></label>`;
  }
  if(typ==="sklizen") {
    html += `<label>Plodina: <input type="text" id="udalostPlodina"/></label>
             <label>Výnos (kg): <input type="number" id="udalostVynos"/></label>`;
  }
  html += `<label>Poznámka: <input type="text" id="udalostPoznamka"/></label>
