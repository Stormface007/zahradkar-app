  ...
  fetch(SERVER_URL, {
    ...
    .then(resp => {
      if (resp === "OK") {
        ...
        alert("Chyba mazání události: " + resp);
      }
    })
...
// ----------------------
// Přepínání režimů v modálním okně
// ----------------------
